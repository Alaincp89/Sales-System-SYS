...
public class Reportes {
    ...
    *********************************************************************** */
    public void ReportesClientes() {
        ...
        try {
            String ruta = "C:\\Users\\Informatica\\Desktop";
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "/Reportes/Clientes/Reporte_Clientes.pdf"));
    ...
    *********************************************************************** */
    public void ReportesProductos() {
        ...
        try {
            String ruta = "C:\\Users\\Informatica\\Desktop";
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "/Reportes/Productos/Reporte_Productos.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesCategorias() {
        ...
        try {
            String ruta = "C:\\Users\\Informatica\\Desktop";
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "/Reportes/Categorias/Reporte_Categorias.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesVentas() {
        ...
        try {
            String ruta = "C:\\Users\\Informatica\\Desktop";
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "/Reportes/Ventas/Reporte_Ventas.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
